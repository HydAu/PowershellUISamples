...
$wsdlStream = $stream_reader.ReadToEnd()
$wsdlStream
...
$wsdlStream = 'a.wsdl'
#   Exception calling "Read" with "1" argument(s): "Could not find file
# 'C:\Users\sergueik\a.wsdl'."
# need get script directory 
# set-content -Path "C:\Users\sergueik\code\powershell\${wsdlStream}" -value $wsdlStream_contents -encoding ASCII
